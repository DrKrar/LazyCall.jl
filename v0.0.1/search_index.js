...

{
    ...
    "title": "LazyCall.jl",
    "category": "section",
    "text": "LazyCall allows you to store a function along with its arguments for later use. This is particularly useful in functional programming. Here's a quick demo:julia> using ChainRecursive, LazyCall, Base.Generator\n\njulia> @chain begin\n           [-2, 0, -2, 0]\n           @unweave ~_ + 1 > 0\n           Generator\n           sum\n       end\n2Methods on LazyCalls are currently defined for only four base functions: map, filter, broadcast, and Base.Generator. However, there is the potential for many more methods. I've created a wish-list issue on github for ideas.Modules = [LazyCall]"
},
